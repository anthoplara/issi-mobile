...
class RaceItemWidget extends StatelessWidget {
  final RaceListData data;
  final String source;
  const RaceItemWidget({Key? key, required this.data, required this.source}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var mediaSize = MediaQuery.of(context).size;

    String showDate = data.tglRace ?? "-";
    if (showDate != "-") {
