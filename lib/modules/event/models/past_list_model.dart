class PastListModel {
  ...
  PastListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'] as int?;
    error = json['error'] as bool?;
    data = (json['data'] as List?)?.map((dynamic e) => PastListData.fromJson(e as Map<String, dynamic>)).toList();
  }
...
class PastListData {
  ...
  PastListData.fromJson(Map<String, dynamic> json) {
