...
class RegulationListView extends StatefulWidget {
  final int categoryId;
  final String categoryName;
  const RegulationListView({Key? key, required this.categoryId, required this.categoryName}) : super(key: key);

  @override
  State<RegulationListView> createState() => _RegulationListViewState();
}

class _RegulationListViewState extends State<RegulationListView> {
